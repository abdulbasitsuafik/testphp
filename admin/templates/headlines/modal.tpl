                    ...
                    <div role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist" id="myTab">
                                    {% for value in languages %}
                                        <li role="presentation" {% if value.ranks == "1" %}class="active" {% endif %}>
                                            <a href="#dil_{{value.ranks}}" aria-controls="dil_{{value.ranks}}" role="tab" data-toggle="tab">
                                                {{value.code}}
                                            </a>
                                        </li>
                                    {% endfor %}
                                    ...
                                    <div class="tab-content">
                                        {% if page_type == "edit" %}
                                            {% for value in language_content %}
                                                <div role="tabpanel" class=" {% if value.lang == "1" %}active{% endif %} tab-pane" id="dil_{{value.lang}}">
                                        ...
                                        {% elseif page_type == "add"  %}
                                            {% for dil in languages %}
                                                {% set dil_rank = dil.ranks %}
                                                {% set items = [{ 'dil_rank': dil_rank}] %}
                                                <div role="tabpanel" class="{% if dil_rank == "1" %}active{% endif %}  tab-pane" id="dil_{{dil_rank}}">
                                                    <div class="row">
