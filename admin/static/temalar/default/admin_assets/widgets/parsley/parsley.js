...
// Define then the messages
    window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
        defaultMessage: "Bu değer geçersiz gibi görünüyor.",
        type: {
            email:        "Bu değer geçerli bir e-posta olmalıdır.",
            url:          "Bu değer geçerli bir URL olmalıdır.",
            number:       "Bu değer geçerli bir numara olmalıdır.",
            integer:      "Bu değer geçerli bir tam sayı olmalıdır.",
            digits:       "Bu değer basamak olmalıdır.",
            alphanum:     "Bu değer alfa sayısal olmalıdır."
        },
        notblank:       "Bu değer boş bırakılmamalıdır.",
        required:       "Bu değer gereklidir.",
        pattern:        "Bu değer geçersiz gibi görünüyor.",
        min:            "Bu değer,% s 'dan büyük veya ona eşit olmalıdır.",
        max:            "Bu değer % s 'den daha düşük veya ona eşit olmalıdır.",
        range:          "Bu değer % s ve % s arasında olmalıdır.",
        minlength:      "Bu değer çok kısa. % S karakter veya daha fazla karakter içermelidir.",
        maxlength:      "Bu değer çok kısa. It should have %s characters or fewer.",
        length:         "Bu değer yanlış. It should be between %s and %s characters long.",
        mincheck:       "You must select at least %s choices.",
        maxcheck:       "You must select %s choices or fewer.",
        check:          "You must select between %s and %s choices.",
        equalto:        "Bu değerler aynı olmalıdır"
    });
