...
class Categories extends Controller{
    public function __construct() {
        ...
        $this->newmodel = $this->load->model("categories_model");
...
//            }
    ...
    public function add() {
        ...
        if(@$_POST["modal_getir"]){
            ...
            $data = [];
            ob_start();
            $this->view->render("categories/modal",$data,"1");
...
//        $form = $this->newform;
    ...
    public function dataListe() {
        ...
        if( !empty($requestData['columns'][1]['search']['value']) ){  //salary
                $sql.=" AND category_id LIKE '%".$requestData['columns'][1]['search']['value']."%' ";
        }
...
//        }
            ...
            $makale_liste = $model->categories_list($sql);
            $toplammakale = $model->categories_list();
          //echo $sql;
            $durum = "";
            $data = array();
