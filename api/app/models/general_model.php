...
class general_model extends Model{
    ...
    public function get_single_headlines($id)
    {
        $sql = "SELECT * FROM ".PREFIX."headlines a JOIN ".PREFIX."headlines_langs b ON a.id = b.head_id WHERE head_id = :head_id and b.lang = :lang";
        return $this->db->select($sql, array(':head_id' => $id,"lang"=> 1));
    }
    public function get_headlines_from_top_head($id)
    {
