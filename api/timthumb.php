...
if ($_SERVER["HTTP_HOST"] == "localhost") {
	...
	$parcala = explode("/", $urlal);
	$_SERVER['DOCUMENT_ROOT'] = "C:/Wamp/www/".$parcala[1];
	//$_SERVER['DOCUMENT_ROOT'] = "C:/Wamp64/www/".$parcala[1]."/".$parcala[2];
}
...
if(! defined('MEMORY_LIMIT') )				define ('MEMORY_LIMIT', '300M');							// Set PHP memory limit
...
if(! defined('NOT_FOUND_IMAGE') )			define ('NOT_FOUND_IMAGE', 'resimler/resimyok.jpg');							// Image to serve if any 404 occurs
