...
class Load{
    ...
    public function otherClasses($fileName,$parameters=[]){
        require_once "app/otherClasses/" . $fileName . ".php";
        return new $fileName($parameters);
    } 
    
    public function siteModel($fileName){
        require_once "app/models/site/" . $fileName . ".php";
        return new $fileName();
    }    
}
